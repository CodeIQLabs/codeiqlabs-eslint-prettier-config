...
- **`.github/workflows/ci.yml`** – Pull request checks for formatting, build, tests, and
...
- **`dist/`** *(generated)* – Emitted build artifacts for ESM/CJS and type declarations; generated by
  the TypeScript build and excluded from source control.
